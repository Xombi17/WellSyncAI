...
import { Plus, User, Calendar, Activity, ChevronRight } from 'lucide-react';

const dependents = [
  { id: '1', name: 'Aarav Sharma', type: 'Child', age: '2 years', dob: '2024-01-15', image: 'https://picsum.photos/seed/aarav/100/100' },
  { id: '2', name: 'Priya Sharma', type: 'Adult', age: '28 years', dob: '1996-05-20', image: 'https://picsum.photos/seed/priya/100/100' },
  { id: '3', name: 'Kamala Sharma', type: 'Elder', age: '65 years', dob: '1959-11-02', image: 'https://picsum.photos/seed/kamala/100/100' },
];
        ...
        {dependents.map((dependent) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="w-20 h-20 rounded-[1.25rem] bg-white dark:bg-slate-700 p-1 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1)] dark:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.5)]">
                <img src={dependent.image} alt={dependent.name} className="w-full h-full object-cover rounded-xl" />
              </div>
            ...
            <div className="mt-auto space-y-3 bg-white dark:bg-slate-700 rounded-2xl p-4 shadow-[inset_2px_2px_6px_rgba(0,0,0,0.02),inset_-2px_-2px_6px_rgba(255,255,255,0.8)] dark:shadow-[inset_2px_2px_6px_rgba(0,0,0,0.2),inset_-2px_-2px_6px_rgba(255,255,255,0.05)]">
              <div className="flex items-center gap-3 text-sm font-bold text-slate-500 dark:text-slate-400">
                ...
                <span>Age: {dependent.age}</span>
              </div>
              <div className="flex items-center gap-3 text-sm font-bold text-slate-500 dark:text-slate-400">
                <Calendar size={16} className="text-blue-400" />
                <span>DOB: {dependent.dob}</span>
              </div>
            </div>
          </Link>
        ))}
