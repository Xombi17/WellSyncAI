...
# Database setup
DATABASE_URL = "postgresql+asyncpg://postgres:Oxamm7eE3RoubzZ1@db.azvvmmekxfcuzdadxlub.supabase.co:5432/postgres"
engine = create_async_engine(DATABASE_URL, echo=True)
AsyncSessionLocal = async_sessionmaker(engine, class_=AsyncSession, expire_on_commit=False)

DEMO_FAMILIES = [
    {"username": "sharma", "name": "Sharma Family", "email": "sharma@wellsync.demo", "password": "wellsync2026"},
    {"username": "patel", "name": "Patel Family", "email": "patel@wellsync.demo", "password": "wellsync2026"},
    {"username": "kumar", "name": "Kumar Family", "email": "kumar@wellsync.demo", "password": "wellsync2026"},
    {"username": "singh", "name": "Singh Family", "email": "singh@wellsync.demo", "password": "wellsync2026"},
    {"username": "verma", "name": "Verma Family", "email": "verma@wellsync.demo", "password": "wellsync2026"},
]
